...
<section class="contact-secton">
    <div class="contact-secton__container">
        ...
        <div class="contact-secton__row">
            <a href="tel:<?php echo $BASICINFO['phone_one']; ?>">
            Toll Free: <?php echo $BASICINFO['phone_one']; ?>
            </a>
        </div>
        <div class="contact-secton__row">
            <a href="tel:<?php echo $BASICINFO['phone_two']; ?>">
            Toll Free:<?php echo $BASICINFO['phone_two']; ?>
            </a>
        </div>
        <div class="contact-secton__row">
